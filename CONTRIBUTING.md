...
```bash
git clone https://github.com/taugr/scranbook.git
cd scranbook
pnpm install
```
...
Open an issue at [https://github.com/taugr/scranbook/issues](https://github.com/taugr/scranbook/issues).
